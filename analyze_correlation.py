"""
analyze_correlation.py — Pearson / Spearman correlation between conflict
count and compliance score, for the RQ2 vs RQ3 relationship.
...
df = pd.read_csv("log/robots_data_fixed.csv")
